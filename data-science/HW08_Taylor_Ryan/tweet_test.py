...
log_word_freqencies = ## Your code here (Transpose what you read)
...
most_common_sentiment = ## Your code here
freq_of_most_common = ## Your code here
print(f"Would get {freq_of_most_common * 100.0:.1f}% accuracy by guessing \"{most_common_sentiment}\" every time.")
...
with open('test_tweet.csv', 'r') as f:
    ...
    for row in reader:
        ...
        tweet = ## Your code
        sentiment = ## Your code (it should be an int)
        ...
        log_likelihoods = ## Your code here (refer to the lecture) (It is a matrix times a vector)
...
tweet_count = ## Your code
correct_count = ## Your code
print(f"{tweet_count} lines analyzed, {correct_count} correct ({100.0 * correct_count/tweet_count:.1f}% accuracy)")
cm = ## Your code
print(f"Confusion: \n{cm}")
...
ax.plot(thresholds, correct_ratio, 'blue', linewidth=0.8, label="Accuracy Above Threshod")
...
ax.plot(thresholds, confident_ratio,'r',linestyle='dashed', linewidth=0.8,label="Tweets scoring above threshold")
ax.legend()
